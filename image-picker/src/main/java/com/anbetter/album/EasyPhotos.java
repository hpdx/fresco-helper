...
import com.anbetter.album.builder.AlbumBuilder;
...
import com.anbetter.album.models.sticker.entity.TextStickerData;
import com.anbetter.album.setting.Setting;
import com.anbetter.album.ui.PreviewActivity;
import com.anbetter.album.utils.bitmap.BitmapUtils;
...
import com.anbetter.album.utils.result.EasyResult;
...
//*************************bitmap功能***********************************/
     ...
     *
     * @param act           上下文
     * @param photoInfos        图片集合（最多对9张图片进行拼图）
     ...
     * @param callback      拼图回调
     */
    public static void startPuzzleWithPhotos(FragmentActivity act, ArrayList<PhotoInfo> photoInfos, boolean replaceCustom, @NonNull ImageEngine imageEngine, PuzzleCallback callback) {
        act.setResult(Activity.RESULT_OK);
        EasyResult.get(act).startPuzzleWithPhotos(photoInfos, replaceCustom, imageEngine, callback);
    }
     ...
     * @param photoInfos        图片Photo集合
     * @param bottomPreview 是否显示底部预览效果
     */
    public static void startPreviewPhotos(FragmentActivity act, @NonNull ImageEngine imageEngine, @NonNull ArrayList<PhotoInfo> photoInfos, boolean bottomPreview) {
        Setting.imageEngine = imageEngine;
        PreviewActivity.start(act, photoInfos, bottomPreview);
    }
    ...
    public static void startPreviewPaths(FragmentActivity act, @NonNull ImageEngine imageEngine, @NonNull ArrayList<String> paths, boolean bottomPreview) {
        ...
        for (String path : paths) {
            PhotoInfo photoInfo = new PhotoInfo(null, path, 0, 0, 0, 0, 0, "");
