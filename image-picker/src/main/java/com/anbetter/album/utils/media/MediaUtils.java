package com.anbetter.album.utils.media;
...
public class MediaUtils {
    ...
    @Nullable
    public static Pair<String, PhotoInfo> getPhoto(Context context, File file) {
        ...
        Pair<String, PhotoInfo> pair = null;
        ...
        if (cursor.moveToFirst()) {
            ...
            PhotoInfo photoInfo = new PhotoInfo(name, path, dateTime, width, height, size, duration, type);
            pair = new Pair<>(bucketName, photoInfo);
        }
        cursor.close();
        return pair;
    }
