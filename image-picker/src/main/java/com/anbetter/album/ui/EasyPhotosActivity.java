...
//        String imageName = "IMG_CROP_%s" + getImageSuffix(photoInfo.type);
        String destinationFileName = "IMG_CROP_Temp.jpg"; // String.format(imageName, dateFormat.format(new Date()));
        ...
        String cropCacheDir = FileUtils.getCropCacheDir(context);
//        File cacheFile = new File(context.getCacheDir(), destinationFileName);
        File cacheFile = new File(cropCacheDir, destinationFileName);
