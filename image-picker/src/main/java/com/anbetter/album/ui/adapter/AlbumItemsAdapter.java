...
public class AlbumItemsAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof AlbumItemsViewHolder) {
            ...
            SimpleDraweeView simpleDraweeView = ((AlbumItemsViewHolder) holder).ivAlbumCover;
            Phoenix.with(simpleDraweeView)
                    .setWidth(DensityUtil.dip2px(mContext, 70))
                    .setHeight(DensityUtil.dip2px(mContext, 70))
